      ...
      <section className="mb-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <section className="mb-8 p-6 bg-gray-100 rounded-lg shadow-md">
            ...
            <Image src='/comp_lab-820x400.png' alt='computer lab' width={710} height={710} className="rounded-lg" />
            </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-12 border-2 gap-5 p-10'>
